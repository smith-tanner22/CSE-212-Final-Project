class Node: #defines the structure of the node
    ...
    def preOrder(self, root):
        ...
        if root:
            ...
            newList = newList + self.preOrder(root.left)
            newList = newList + self.preOrder(root.right)
        return newList
    ...
    def postOrder(self, root):
        ...
        if root:
            newList = self.postOrder(root.left)
            newList = newList + self.postOrder(root.right)
            newList.append(root.data)
        return newList
